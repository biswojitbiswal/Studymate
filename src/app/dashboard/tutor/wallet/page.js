...
import { useTutorWithdrawals, useWithdraw } from "@/hooks/tutor/useWallet";
...
export default function WalletPage() {
    ...
    const { data, isLoading } = useTutorWithdrawals({
        page,
        limit: 5,
    });
    ...
    return (
        <div className="md:py-2 md:px-6 space-y-6">
            <button
                onClick={() => router.back()}
            ...
            <div className="bg-white rounded-xl shadow border overflow-hidden">
                <div className="p-4 border-b font-medium">Withdrawal History</div>
