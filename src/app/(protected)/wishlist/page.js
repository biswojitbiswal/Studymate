...
export default function WishlistPage() {
    ...
    return (
        ...
        //             <div
        //                 key={classItem?.id}
        //                 className="bg-white rounded-md border border-gray-200 p-4 shadow-sm hover:shadow-md transition"
        //             >
        //                 <div className="flex gap-4">
        //                     {/* Thumbnail */}
        //                     <div className="relative w-36 h-28 rounded-md overflow-hidden shrink-0">
        //                         <img
        ...
        //                         {/* Bottom */}
        //                         <div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-auto pt-3">
